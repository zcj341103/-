...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		if (landscape()) {
			...
			seedAbout.setRect(title.x-50, topRegion+GAP-BTN_HEIGHT-3, btnPlay.width()*2+2, BTN_HEIGHT);
		} else {
			...
			seedAbout.setRect(title.x, topRegion+GAP-BTN_HEIGHT-3, title.width(), BTN_HEIGHT);
		}
