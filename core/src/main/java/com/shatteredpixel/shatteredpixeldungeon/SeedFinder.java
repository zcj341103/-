...
public class SeedFinder {
	...
	public String[] addDungeon(int floors, int max, String seed, ArrayList<String> seek){
	...
	private static class ItemData {
		...
		static{
			...
			items.put("装填之戒", "RingOfReload");
			items.put("浮躁之戒", "RingOfRush");
			items.put("血饮之戒", "RingOfVampire");
			items.put("饱腹之戒", "RingOfSatisfying");
			items.put("盛怒之戒", "RingOfFury");
			items.put("护佑之戒", "RingOfShield");
			items.put("锐利之戒", "RingOfVorpal");
			...
			items.put("时空道标", "LloydsBeacon");
			items.put("荆棘斗篷", "CapeOfThorns");
		}
